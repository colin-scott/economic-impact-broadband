...
% Interesting follow-on questions from Isha:
% (1) Just wondering if primary school enrollment is a good proxy for an outcome that seeks to correlate growth with internet penetration. High school might be more relevant? This is a gut feeling and not an informed comment, I must admit.
% (2) Also wondering what the cost of 10% broadband penetration might be even if it does "lead to" 1.3% growth; what else might lead to 1.3% growth and is broadband cost-effective in comparison? This is NOT the point of your paper but I think it's worth considering for future ICT-or-not-for-D policy.
